...
async function LoadFromApi() {
    ...
    try {
        const responseAPI = await fetch('http://localhost:3000/api/products?id=' + id2);
    ...
    document.getElementsByClassName('item-detail')[0].innerHTML += `
                ...
                <div class="navigation-bar">
                    ...
                    <div class="text-nav">
                        ...
                        <p>/</p>
                        <div class="normal-text">${product.title}</div>
                    </div>
                </div>
                ...
                <div class="content-detail-image">
                    ...
                    <div id="detail-image-detail-product" class="detail-image">
